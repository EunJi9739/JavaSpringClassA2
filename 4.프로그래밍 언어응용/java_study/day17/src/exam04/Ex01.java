...
public class Ex01 {
    public static void main(String[] args){
        ...
        String yoilStr = date1.getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.KOREAN);

        System.out.printf("year=%d, month=%d, day=%d, yoil=%s, yoilStr=%s%n",year,month,day,yoil,yoilStr);
    }
}
