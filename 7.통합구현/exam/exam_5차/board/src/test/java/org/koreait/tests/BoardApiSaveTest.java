...
public class BoardApiSaveTest {
    ...
    public String getParam(String sub, String con){
        String param = String.format("{\"subject\" : \"%s\", \"content\":\"%s\"}",sub,con);
        return param;
    }
    ...
    @Test
    @DisplayName("게시글 저장 시 필수항목(제목) 여부 확인")
    void requiredSubjectCheck() throws Exception {
        String params = getParam("","내용");
    ...
    @Test
    @DisplayName("게시글 저장 시 필수항목(내용) 여부 확인")
    void requiredContentCheck() throws Exception {
        String params = getParam("제목","");
